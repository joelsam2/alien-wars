...
void checkCollision(void) {
  ...
  // spaceship collision
  if (matrixbuff[x1][y1 - 1] == 7) {
    bullet_collision_1 = true;
  } else if (matrixbuff[x1][y1 - 1] == 4 || matrixbuff[x1][y1 - 1] == 5) {
    spacecraft_collision_1 = true;
  }

  if (matrixbuff[x2][y2 - 1] == 7) {
    bullet_collision_2 = true;
  } else if (matrixbuff[x2][y2 - 1] == 4 || matrixbuff[x2][y2 - 1] == 5) {
...
void refreshDisplayTask() {
  ...
  while (1) {
    ...
    if (bullet_collision_1 == true || spacecraft_collision_1 == true) {
      drawEnemy(x1, y1, 0);
    } else if (bullet_collision_2 == true || spacecraft_collision_2 == true) {
      drawEnemy(x2, y2, 0);
    }
    clearDisplay();
    vTaskDelay(6);
